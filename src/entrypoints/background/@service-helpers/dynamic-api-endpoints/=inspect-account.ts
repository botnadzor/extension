...
const legacyLikeToBotSchema = z.readonly(
  z.object({
    ...
    bot_name: z.exactOptional(z.nullable(z.string())), // e.g "Иван Иванов"
    mark: z.exactOptional(z.nullable(z.string())), // e.g "Алтайский край"
    mark_color: z.exactOptional(z.nullable(z.string())), // e.g "linear-gradient(to right, #fd79a8, #5d5d5d)"
    ...
    z.object({
      body: z.union([
        z.object({
          ...
          legacy: z.object({
            name: z.exactOptional(z.nullable(z.string())),
            mark: z.exactOptional(z.nullable(z.string())),
            mark_color: z.exactOptional(z.nullable(z.string())),
            mark_title: z.exactOptional(z.nullable(z.string())),
            comments_advanced: z.exactOptional(
              z.nullable(z.array(legacyCommentSchema)),
            ),
            comments: z.exactOptional(z.nullable(z.array(legacyCommentSchema))),
            likes: z.exactOptional(z.nullable(z.array(legacyLikeToBotSchema))),
            reviews: z.exactOptional(z.nullable(z.array(legacyCommentSchema))),
          }),
